...
- [BlogRoll](#blogroll)
  ...
  - [:he  - [➕ Cloud Services Comparison](#-cloud-services-comparison)

  - [:roc  - [🚀 DevOps](#-devops)

  - [:larg  - [🔷 Azure Active Directory](#-azure-active-directory)

  - [:open\  - [📂 Misc](#-misc)

  - [:seedli  - [🌱 Sustainability](#-sustainability)

  - [:cloud:   - [☁️ HA and DR](#-ha-and-dr)

  - [:notebook  - [📓 Portals](#-portals)

  - [:classical  - [🏛️ Architecture](#-architecture)

  - [:fire\_engi  - [🚒 Support](#-support)

  - [:school: Gov  - [🏫 Governance](#-governance)

  - [:label: Tags]  - [🏷️ Tags](  - [🎥 Videos](#-videos)
ra: Videos](#movie_ca  - [📚 DashB  - [🐙 GitHub](#-github)
Boards](#books-dashboa  -   - [🗽 LightHouse](#-lighthouse)
tHub](#octocat-github)  - [🚓 Compliance](#-compliance)
ns)
  - [:statue\_of\_li  - [💻 Virtual machines](#-virtual-machines)
e)
  - [:police\_car: Co  - [↗️ Virtual Machines Scale Set](#-virtual-machines-scale-set)
e)
  - [:computer: Virtua  - [🅰️ ARM](#-arm)
s)
  - [:arrow\_upper\_rig  - [⏱️ Analytics and monitoring](#-analytics-and-monitoring)
t)
  - [:a: ARM](#a-arm)
   - [🥷 Security](#-security)
g)
  - [:ninja: Security](#n  - [👨‍💻 Ter  - [🔄 Terraform Deployment](#-terraform-deployment)
aform](#technologist-terraform  - [💪 Bicep](#-bicep)
nt)
  - [:muscle: Bicep](#musc  - [🌍   - [🌐 Network](#-network)
(#earth_africa-web)
  - [:globe  - [🧱 Routing and NVA](#-routing-and-nva)
ork)
  - [:bricks: Routing and N  - [📖 Migration](#-migra  - [🎉 Fun Images](#fun-images)
ok-migration)
  - [Fun Images](#f
ages)>
ial and custom sources.
## 🆕 New T
rom official and customHello! 👋
##
eck
...
🙈 :see_no_evi😄
 :h
 :speak_no_evi[Back To To
- [A
##
rtif[Back To Top
- [Official ce- [Brow- [Micr- [Exam Sandbox, de- [Microsoft learn community](https://techcommunity.microsoft.com/t5/microsoft-learn/ct-p/MicrosoftLearn)
ions by roles](https://learn.microsoft.com/en-us/certifications/)
cations training poster](https://aka.ms/TrainCertPoster) 🔥
contents)
re Deployment Environments](https://techcommunity.microsoft.com/t5/azure-developer-community-blog/introducing-azure-deployment-environments/ba-p/3412095)
(#table-of-contents)
