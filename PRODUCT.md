...
- **One shared page shell across 63 pages** (31 hand-authored + 32 generated). Sitewide changes are done as a throwaway codemod over the 31, plus an edit to `pageShell()` and a rebuild.
